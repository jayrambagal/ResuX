...
export const ResumeDropzone = ({
  ...
  return (
    <div
      className={cx(
        "flex justify-center rounded-md border-2 border-dashed border-gray-600 px-6 ",
    ...
    >
      ...
      >
        {!playgroundView && (
          <FaFilePdf className="mx-auto h-14 w-14 text-gray-200 " />
        )}
        {!hasFile ? (
          <>
            <p
              className={cx(
                "pt-3 text-gray-400",
                !playgroundView && "text-lg "
              )}
            >
              Browse a pdf file or drop it here
            </p>
            <p className="flex text-sm text-gray-400">
              <FaLock className="mr-1 mt-1 h-3 w-3 text-gray-400" />
          ...
          <div className="flex items-center justify-center gap-3 pt-3">
            ...
            <button
              type="button"
              className="outline-theme-blue rounded-md p-1 text-white"
              title="Remove file"
              onClick={onRemove}
            >
